      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            //console.log(res)
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Ready to travel with us? Go Ahead!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1700);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Please check you email box');
              window.setTimeout(function () {
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(password, passwordValidation, token) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(travelId) {
    var session, stripe;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/bookings/checkout-stripe/".concat(travelId));
  ...
  return function BookTravel(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.BookTravel = BookTravel;
...
var resetPasswordForm = document.querySelector('.resetpassword--form');
var updatePasswordForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-travel');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _signup.signup)(formField, 'data');
  });
}
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _login.login)(email, password); // clear fields
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault(); // display feedback to users
...
if (resetPasswordForm) {
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee(e) {
      var password, passwordValidation, token;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordValidation = document.querySelector('input#passwordValidation').value;
              token = document.querySelector('input#resetToken').value;
              _context.next = 6;
              return (0, _resetpassword.resetPassword)(password, passwordValidation, token);
...
if (updateSettingsForm) {
  updateSettingsForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSettings)(formField, 'data');
  });
}
...
if (updatePasswordForm) {
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee2(e) {
      var currentPassword, password, passwordValidation;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault(); // Give user feedback
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "39215" + '/');
